...
var DIGIT = exports.DIGIT = 'DIGIT';
var OPERATION = exports.OPERATION = 'OPERATION';
var RESET = exports.RESET = 'RESET';
var EVAL = exports.EVAL = 'EVAL';
...
var isValidDigit = exports.isValidDigit = function isValidDigit(value) {
  return (/^[\d\.]$/.test(value)
  );
};

var isValidOperation = exports.isValidOperation = function isValidOperation(value) {
  return (/^[\+\-]$/.test(value)
  );
};
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(13), __webpack_require__(64)(module)))
...
var _withKeyboard = __webpack_require__(74);

var _withKeyboard2 = _interopRequireDefault(_withKeyboard);
...
var calc = (0, _withKeyboard2.default)(_Calc2.default);

var mapStateToProps = function mapStateToProps(_ref) {
    var calc = _ref.calc;
    return _extends({}, calc);
};
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(calc);
...
var Validator = _interopRequireWildcard(_validators);
...
var withKeyboard = function withKeyboard(WrappedComponent) {
    ...
    return function (_Component) {
        ...
        function _class2(props) {
            ...
            _this.handleKeyDown = function (_ref) {
                var key = _ref.key;
...
var _Screen = __webpack_require__(76);

var _Screen2 = _interopRequireDefault(_Screen);

var _Keyboard = __webpack_require__(77);
...
Calc.propTypes = {
    ...
    operation: _propTypes2.default.string,
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(_Button2.default, {
                ...
                onClick: function onClick() {
                    return _onClick(Actions.DIGIT, 7);
                }
            }),
            _react2.default.createElement(_Button2.default, {
                label: '8',
                active: '8' === active,
                onClick: function onClick() {
                    return _onClick(Actions.DIGIT, 8);
                }
            }),
            _react2.default.createElement(_Button2.default, {
                label: '9',
                active: '9' === active,
                onClick: function onClick() {
                    return _onClick(Actions.DIGIT, 9);
                }
            }),
            _react2.default.createElement(_Button2.default, {
                label: '+',
                ...
                type: 'operation',
                onClick: function onClick() {
                    return _onClick(Actions.OPERATION, Operations.PLUS);
                }
            })
        ),
        _react2.default.createElement(
            ...
            _react2.default.createElement(_Button2.default, {
                ...
                active: '4' === active,
                onClick: function onClick() {
                    return _onClick(Actions.DIGIT, 4);
                }
            }),
            _react2.default.createElement(_Button2.default, {
                label: '5',
                active: '5' === active,
                onClick: function onClick() {
                    return _onClick(Actions.DIGIT, 5);
                }
            }),
            _react2.default.createElement(_Button2.default, {
                label: '6',
                active: '6' === active,
                onClick: function onClick() {
                    return _onClick(Actions.DIGIT, 6);
                }
            }),
            _react2.default.createElement(_Button2.default, {
                label: '-',
                ...
                type: 'operation',
                onClick: function onClick() {
                    return _onClick(Actions.OPERATION, Operations.MINUS);
                }
            })
        ),
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(_Button2.default, {
                        ...
                        active: '1' === active,
                        onClick: function onClick() {
                            return _onClick(Actions.DIGIT, 1);
                        }
                    }),
                    _react2.default.createElement(_Button2.default, {
                        label: '2',
                        active: '2' === active,
                        onClick: function onClick() {
                            return _onClick(Actions.DIGIT, 2);
                        }
                    }),
                    _react2.default.createElement(_Button2.default, {
                        label: '3',
                        active: '3' === active,
                        onClick: function onClick() {
                            return _onClick(Actions.DIGIT, 3);
                        }
                    })
                ),
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(_Button2.default, {
                        ...
                        active: '0' === active,
                        onClick: function onClick() {
                            return _onClick(Actions.DIGIT, 0);
                        }
                    }),
                    _react2.default.createElement(_Button2.default, {
                        label: '.',
...
var Button = function Button(_ref) {
    ...
    return _react2.default.createElement(
        'button',
        { className: classNames.join(' '), onClick: onClick },
        label
    );
};
...
var calculate = function calculate(origin, operation, value) {
    value = +value;
    origin = +origin;
...
var setDigit = function setDigit(state, value) {
    if (Validator.isValidDigit(value)) {
        var newValue = state.value === '0' ? value.toString() : state.value.concat(value);
...
var setOperation = function setOperation(state, operation) {
...
var setResult = function setResult(state) {
...
if(false) {
	module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/less-loader/dist/cjs.js!./variables.less", function() {
		var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/less-loader/dist/cjs.js!./variables.less");
...
// module
exports.push([module.i, "html {\n  background-color: #000;\n  height: 100%;\n}\nbody {\n  margin: 0;\n  padding: 0;\n  height: 100%;\n  position: relative;\n}\n#root {\n  height: 100%;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\nmain {\n  border: 1px solid #0f0;\n}\n.keyboard .flex {\n  display: flex;\n}\n.keyboard button {\n  background: #000;\n  color: #0f0;\n  font-weight: bold;\n  width: 50px;\n  padding: 10px;\n  border: 1px solid #0f0;\n}\n.keyboard button:hover {\n  background: rgba(0, 255, 0, 0.3);\n}\n.keyboard button:active,\n.keyboard button.active {\n  background: #0f0;\n  color: #000;\n}\n.keyboard button.operation {\n  color: #ff0;\n}\n.keyboard button.operation:hover {\n  background: rgba(255, 255, 0, 0.3);\n}\n.keyboard button.operation:active,\n.keyboard button.operation.active {\n  background: #ff0;\n  color: #000;\n}\n.keyboard button.reset {\n  color: #f00;\n}\n.keyboard button.reset:hover {\n  background: rgba(255, 0, 0, 0.3);\n}\n.keyboard button.reset:active,\n.keyboard button.reset.active {\n  background: #f00;\n  color: #000;\n}\n.screen {\n  height: 50px;\n  font-size: 26px;\n  color: #fff;\n  text-align: right;\n  font-weight: bold;\n  position: relative;\n  font-family: \"Courier New\";\n}\n.screen .temp {\n  font-size: 18px;\n  min-height: 20px;\n  font-weight: normal;\n}\n.screen span {\n  position: absolute;\n  top: 12px;\n  left: 4px;\n  font-size: 23px;\n  color: #ff0;\n}\n", ""]);
